...
function toggleYardsale (data) {
	if(data == '1'){
		btnState.val('0').addClass('btn-danger').removeClass('btn-danger').text('visible (click to hide)');
	}else{
		btnState.val('1').addClass('btn-primary').removeClass('btn-primary').text('hidden (click to show)');
	}
}
